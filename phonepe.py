...
if select == "HOME":
    ...
    with col2:
        st.image(Image.open(r"E:\GUVI\projects\PhonePe\images\phonepelogo.png"),width= 600)

    col3,col4= st.columns(2)
    
    with col3:
        st.image(Image.open(r"E:\GUVI\projects\PhonePe\images\phonepepic.jpg"),width=600)
    ...
    with col6:
        st.image(Image.open(r"E:\GUVI\projects\PhonePe\images\Phonepepic1.jpg"),width= 600)
